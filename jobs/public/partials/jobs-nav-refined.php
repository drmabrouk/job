	...
	public function add_custom_nav_bar() {
		...
		<nav class="jobs-global-top-nav-refined">
			<div class="nav-content-container">
				<!-- Left Side (Logo in LTR, Apps/Profile in RTL) -->
				...
				<!-- Right Side (Actions in LTR, Logo in RTL) -->
					...
					<div class="top-nav-actions-group">
						...
						<?php if ( $is_logged_in ) : ?>
							<div class="notif-msg-group">
								<div class="nav-icon-wrapper" id="jobs-notif-trigger">
								...
								<div class="nav-icon-wrapper" id="jobs-msg-trigger">
						...
						<div class="apps-launcher-grid">
							...
							<?php if ( $is_seeker ) : ?>
								<a href="<?php echo home_url('/jobs-dashboard?tab=my-applications'); ?>" class="app-item">
									...
									<span><?php _e( 'Submitted Applications', 'jobs' ); ?></span>
								</a>
								<a href="<?php echo home_url('/job-seeker/' . $user->user_nicename); ?>" class="app-item">
									...
									<span><?php _e( 'View Public Profile', 'jobs' ); ?></span>
								</a>
							<?php endif; ?>
