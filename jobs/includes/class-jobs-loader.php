 ...
 * Register all actions and filters for the plugin.
 *
 * Maintain a list of all hooks that are registered throughout the plugin, and then
 * register them with the WordPress API. At the same time, maintaining a list
 * of all hooks in a single place keeps the code more organized.
 *
 * @package    Jobs
 * @subpackage Jobs/includes
